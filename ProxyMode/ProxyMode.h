...
public:
	...
	{ 
		...
		switch (strategy)
		{
		case eStrategy::NORMAL: {cout << "代理商正常盈利价格*1.5倍" << endl; }break;
		case eStrategy::DOUBLE_11: {cout << "代理商双11活动超级大促销半价" << endl; }break;
		case eStrategy::DOUBLE_12: {cout << "代理商双12活动促销厂家原价" << endl; }break;
		default:break;
